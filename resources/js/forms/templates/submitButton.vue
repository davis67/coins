<template>
    <div class="form-group">
        <button class="inline-block leading-tight bg-blue-700 border border-blue-700 hover:bg-blue-700 uppercase px-3 py-3 text-white no-underline" :class="btnClass" :type="type" :disabled="isDisabled">
