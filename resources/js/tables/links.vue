<template>
    <nav class="flex justify-between px-2 py-2">
        <span
            class="px-3 text-sm lg:text-lg text-gray-800 py-2"
        >
            Showing Up to
        ...
        <ul
            class="flex list-reset border border-gray-200 rounded w-auto"
            v-if="paginator.shouldPaginate"
        >
            <li
                class="page-item"
                :class="{ disabled: paginator.onFirstPage }"
            >
                <a
                    class="block hover:text-gray-400 hover:bg-blue text-blue border-r border-gray-200 px-3 py-2"
                    href="#"
                    aria-label="Previous"
            ...
            <li
                class="page-item"
                :class="{ disabled: paginator.onLastPage }"
            >
                <a
