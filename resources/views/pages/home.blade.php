            ...
            <div class="flex-grow flex flex-col bg-white border-t border-b sm:rounded sm:border shadow overflow-hidden">
                <div class="border-b">
                    <div class="flex justify-between px-6 -mb-px">
                        <h3 class="text-blue-700 py-4 font-normal text-lg">Your Portfolio</h3>
                        <div class="flex">
                            <button type="button"
                                class="appearance-none py-4 text-blue-700 border-b border-blue-700 mr-3">
                                List
                            </button>
                            <button type="button"
                                class="appearance-none py-4 text-gray-700 border-b border-transparent hover:border-gray-700">
                                Chart
                            </button>
                        </div>
                    </div>
                </div>
                <div class="flex-grow flex px-6 py-6 text-gray-700er items-center border-b -mx-4">
                ...
                <div class="flex-grow flex px-6 py-6 text-gray-700 items-center border-b -mx-4">
                    <div class="w-2/5 xl:w-1/4 px-4 flex items-center">
