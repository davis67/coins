				...
				<form id="opportunitiesFilterForm">
					...
					<div class="form-row">
						...
						<div class="col-md-2">
							...
							<input list="oppCountry" name="opportunityCountry" id="opportunityCountry"
								class="form-control">
						...
						<div class="col-md-2">
							...
							<input type="date" name="opportunityStart" id="opportunityStart" class="form-control"
								required>
						</div>
						<div class="col-md-2">
					...
					<div class="form-row mt-2">
						<div class="btn-group mx-auto">
							<button type="button" id="opportunityFilter" class="btn btn-outline-success mb-2">Search
