        ...
        <form class="form-group" action="{{route('users.store')}}" method="POST">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <input type="text" name="staffId" id="staffId" class="form-control" placeholder="AHC/000/00"
                        maxlength="10">
            ...
            <button type="submit" class="btn btn-outline-primary mt-2 btn-sm"><i class="fas fa-plus"></i> Register a
                User </button>
    </div>
    </form>
</div>
