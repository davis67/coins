...
<div class="card">
    <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                <h5
                    class="card-title float-left m-t-20 m-l-20 m-r-20 align-self-center tasks statistics text-uppercase">
                    {{$leave->leavesetting->leave_type}} details</h5>
                <a href="" class="btn btn-primary float-right m-t-20 m-l-20 m-r-20"></i>Back</a>
                <div class="clearfix"></div>
                <div class="m-t-20 p-20 no-block">
                    <div class="row font-16">
                        <div class="col-lg-3 col-md-3 col-sm-12"> <span
                                class="weight-500 text-dark m-3">Description</span> </div>
                    ...
                    <div class="d-flex font-16">
                        <div class="col-lg-6 p-0 row col-md-12">
                            <div class="col-lg-4 col-md-3 col-sm-12"> <span class="weight-500 text-dark">Status </span>
                            </div>
                            <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 ">
                                <p class=" badge badge-primary"> {{$leave->leave_status}} </p>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-lg-4 col-md-3 col-sm-12"> <span class="weight-500 text-dark">Start
                                    date</span> </div>
                            <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 ">
                                <p> {{$leave->leave_start}} </p>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-lg-4 col-md-3 col-sm-12"> <span class="weight-500 text-dark">Due date</span>
                            </div>
                            <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 ">
                                <p> {{$leave->leave_end}} </p>
                            </div>
                        ...
                        <div class="col-lg-6 row block col-md-12 members-projects">
                            <div class="col-lg-12 col-md-12 col-sm-12 p-0 m-b-15"> <span
                                    class="weight-500 text-dark">Members</span> </div>
